postprocessParser = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c1 = [],
        peg$c2 = null,
        peg$c3 = function(triplets, rest) { return triplets.join("") + rest; },
        peg$c4 = function(a, b, c) { return a + b + c; },
        peg$c5 = void 0,
        peg$c6 = "Answer: ",
        peg$c7 = { type: "literal", value: "Answer: ", description: "\"Answer: \"" },
        peg$c8 = function(skipped) { return skipped; },
        peg$c9 = { type: "other", description: "answer number line" },
        peg$c10 = "\n",
        peg$c11 = { type: "literal", value: "\n", description: "\"\\n\"" },
        peg$c12 = function(line) {return line;},
        peg$c13 = { type: "other", description: "answer set line" },
        peg$c14 = function(first, rest) { var facts = buildList(first, rest, 1);
            return clingoCall(facts); },
        peg$c15 = function() { return "\n"; },
        peg$c16 = /^[^\n]/,
        peg$c17 = { type: "class", value: "[^\\n]", description: "[^\\n]" },
        peg$c18 = function(all) { return all; },
        peg$c19 = { type: "other", description: "predicate" },
        peg$c20 = "(",
        ...
        peg$c26 = function(pred) { return pred; },
        peg$c27 = function(tag) { return tag; },
        peg$c28 = function(num) { return num; },
        peg$c29 = { type: "other", description: "positive integer" },
        peg$c30 = /^[0-9]/,
        ...
        peg$c40 = /^[\x80-\uFFFF]/,
        peg$c41 = { type: "class", value: "[\\x80-\\uFFFF]", description: "[\\x80-\\uFFFF]" },
        peg$c42 = { type: "other", description: "space or tab" },
        peg$c43 = /^[ \t\f]/,
        peg$c44 = { type: "class", value: "[ \\t\\f]", description: "[ \\t\\f]" },
    ...
    function peg$parsetriplet() {
      var s0, s1, s2, s3;

      s0 = peg$currPos;
      s1 = peg$parseskipToAnswer();
      if (s1 !== peg$FAILED) {
        s2 = peg$parseanswerNumLineNl();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseanswersetLineNl();
          if (s3 !== peg$FAILED) {
            peg$reportedPos = s0;
            s1 = peg$c4(s1, s2, s3);
            s0 = s1;
    ...
    function peg$parseskipToAnswer() {
      var s0, s1, s2, s3, s4, s5;
    ...
    function peg$parseanswerNumLineNl() {
      var s0, s1, s2, s3, s4, s5;
    ...
    function peg$parseanswersetLineNl() {
      var s0, s1, s2, s3, s4, s5;
